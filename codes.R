# Peer-graded Assignment: Peer-graded Assignment: Course Project 2
# 2021-09-14 18:15:51 JST
# By Yulong Wang

setwd("/Users/yulong/GitHub/ExData_Plotting2")
...
totalNEI <- NEI[, lapply(.SD, sum, na.rm = TRUE), .SDcols = c("Emissions"), 
                by = year]
...
# (𝚏𝚒𝚙𝚜 == "𝟸𝟺𝟻𝟷𝟶") from 1999 to 2008? Use the base plotting system to 
...
# Question 3
# Of the four types of sources indicated by the 𝚝𝚢𝚙𝚎 
